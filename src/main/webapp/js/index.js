...
var item3 = new Item("page", "#5CD1FF");
var item4 = new Item("torsos", "#FFF15C");
var item5 = new Item("laptop", "#64F592");
var item6=new Item("clipboard-notes","#28a4b3");
