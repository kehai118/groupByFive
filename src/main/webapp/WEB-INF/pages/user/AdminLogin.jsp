...
<head>
    ...
    <title>登录界面</title>
    <link href="/others/forAdminLogin/css/default.css" rel="stylesheet" type="text/css" />
    <!--必要样式-->
    <link href="/others/forAdminLogin/css/styles.css" rel="stylesheet" type="text/css" />
    <link href="/others/forAdminLogin/css/demo.css" rel="stylesheet" type="text/css" />
    <link href="/others/forAdminLogin/css/loaders.css" rel="stylesheet" type="text/css" />
</head>
...
<div class='login'>
    ...
    <div class='login_fields'>
        <div class='login_fields__user'>
            <div class='icon'>
                <img alt="" src='/others/forAdminLogin/img/user_icon_copy.png'>
            </div>
            <input name="login" placeholder='用户名' maxlength="16" type='text' autocomplete="off" value="kbcxy" />
            <div class='validation'>
                <img alt="" src='/others/forAdminLogin/img/tick.png'>
            </div>
        </div>
        <div class='login_fields__password'>
            <div class='icon'>
                <img alt="" src='/others/forAdminLogin/img/lock_icon_copy.png'>
            </div>
        ...
        <div class='login_fields__password'>
            <div class='icon'>
                <img alt="" src='/others/forAdminLogin/img/key.png'>
            </div>
...
<link href="/others/forAdminLogin/layui/css/layui.css" rel="stylesheet" type="text/css" />
<script src="http://www.jq22.com/jquery/jquery-1.10.2.js"></script>
<script src="https://www.jq22.com/jquery/jquery-ui-1.11.0.js"></script>
<script type="text/javascript" src='/others/forAdminLogin/js/stopExecutionOnTimeout.js?t=1'></script>
<script src="/others/forAdminLogin/layui/layui.js" type="text/javascript"></script>
<script src="/others/forAdminLogin/js/Particleground.js" type="text/javascript"></script>
<script src="/others/forAdminLogin/js/Treatment.js" type="text/javascript"></script>
<script src="/others/forAdminLogin/js/jquery.mockjax.js" type="text/javascript"></script>
...
<script type="text/javascript" src="/others/forAdminLogin/img/ThreeWebGL.js"></script>
<script type="text/javascript" src="/others/forAdminLogin/img/ThreeExtras.js"></script>
<script type="text/javascript" src="/others/forAdminLogin/img/Detector.js"></script>
<script type="text/javascript" src="/others/forAdminLogin/img/RequestAnimationFrame.js"></script>
