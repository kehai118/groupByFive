...
;(function($){
	...
	$.fn.planetTravel.defaults = {
		...
		flyStarImage		: [ ['others/forExamHome/images/star-fly-1.png' , 23 ,23 ] ],/*星星图片地址.地址，宽度，高度*/	
		...
		flashStarImage		: [ ['/others/forExamHome/images/star-flash-1.png' , 30 ,27 ] , [ '/others/forExamHome/images/star-flash-2.png' , 40 ,40 ], [ '/others/forExamHome/images/star-flash-2.png' , 40 ,40 ] ],/*星星图片地址 。地址，宽度，高度  */
